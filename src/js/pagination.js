...
const pagination = new Pagination(container, {
  totalItems: 100,
  itemsPerPage: 9,
  visiblePages: window.innerWidth > 375 ? 3 : 2,
  page: 1,
  template: {
    page: '<div class="tui-page-btn hover-class"><a href=""><p class="text">{{page}}</p></a></div>',
    currentPage:
      '<div class="tui-page-btn tui-is-selected"><p class="text">{{page}}</p></div>',
    moveButton:
